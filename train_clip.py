...
class CLIPTrainer:
    def __init__(
        ...
        amp: bool = True,
        output_dir: str = "./clip_checkpoints",
        device: str = "cuda",
        log_every: int = 25,
    ):
        self.device = device
...
def main():
    ...
    parser.add_argument("--index-dir", default="/home/leann/face-detection", help="Directory containing index_*.json files")
    parser.add_argument("--device", default=None, help="e.g. cuda, cuda:0, cpu (default: auto)")
    parser.add_argument("--log-every", type=int, default=25)
    parser.add_argument("--output-dir", default="./clip_checkpoints")
